...
import { Mail, Lock, Eye, EyeOff, Hexagon, Globe } from 'lucide-react';
  ...
  return (
    <div className="w-full h-full relative overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full flex">
        {/* ─── 左侧：品牌展示区（透出底层图片左半部分）─── */}
        <div className="hidden lg:flex w-1/2 flex-col justify-between px-12 py-10">
          {/* 顶部 Logo */}
